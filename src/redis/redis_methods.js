...
export const setToRedis = async (key, value, expire = 1) => {
  try {
...
export const setSetToRedis = async (key, value) => {
  try {
    console.log("Setting to redis: ", key);
...
export const getSetFromRedis = async (key) => {
  try {
...
export const removeSetFromRedis = async (key, value) => {
  try {
...
export const getListFromRedis = async (keyPattern) => {
  try {
...
export const setListFromRedis = async (field, values, expire = 60) => {
...
export const deleteFromRedisByPattern = async (keyPattern) => {
  try {
    const keys = await redis.keys(`*${keyPattern}*`);
    if (!keys.length) {
